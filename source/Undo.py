...
class Undo(object):
    ...
    # TODO This might not be needed type(blob) == Point
    def addAnnPoint(self, annpoint):
        self.operation['remove'].append(annpoint)

    def removeAnnPoint(self, annpoint):
        self.operation['add'].append(annpoint)

    def setAnnPointClass(self, annpoint, class_name):
        self.operation['class'].append((annpoint, annpoint.class_name))
        self.operation['newclass'].append((annpoint, class_name))
